...
const TESTIMONIALS: Testimonial[] = [
  ...
  {
    quote:
      "For two years I'd been hunting for a GHL alternative for local small businesses — the ones who can't justify pricey SaaS subscriptions and don't have the patience to wrestle with them. Answer Any Call finally lets us help more of those businesses while running a more profitable one ourselves.",
  ...
  {
    quote:
      "After exploring tons of options, Answer Any Call was the only thing that came genuinely close to GoHighLevel — and I'm so glad I found it before locking into their expensive plans. Excited to build.",
    name: "Shree Win",
    location: "Los Angeles, California",
    date: "6 June 2026",
  },
  ...
  {
    quote:
      "I purchased Answer Any Call a couple days ago and have it up and going. I'm tweaking it to work with a different payment provider — it's super easy to modify with Claude Code. Looking forward to not needing GHL. :)",
    name: "Haley Estes",
  ...
  {
    quote:
      "I build and customize CRMs for a living, and I was tired of juggling so many different platforms and automation tools. With Answer Any Call I can finally pull all the workflows I've built for clients into one CRM I own — built from the ground up for mortgage brokers in my country. Can't wait to get rid of GHL!",
    name: "Kyle Lesage",
